...
/**
  ...
  *
  * could you create a new data type that captures this requirement better than Either does, with some additional structure?
...
object Exercise08 {
  ...
  /* There is a type very similar to this called `Validation` in the Scalaz library.
     ...
     This idea can even be generalized further--we don't need to accumulate failing values into a list; we can accumulate
