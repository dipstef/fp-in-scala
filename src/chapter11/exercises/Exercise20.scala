...
/**
  ...
  What are its primitive operations? What is the action of flatMap? What meaning does it give to monadic functions like
  sequence, join, and replicateM? What meaning does it give to the monad laws?
...
object Exercise20 {
  ...
  def readerMonad[R] = new ReaderMonad[R] {}
