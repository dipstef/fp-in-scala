...
/**
  * Answer, to your own satisfaction, the question of why it’s not possible for Foldable to extend Functor.
  *
...
object Exercise15 {
  ...
  // This class conceptually represents a sequence of `A` values, generated by repeated function application starting
  // from some seed value. But can you see why it's not possible to define `map` for this type?
