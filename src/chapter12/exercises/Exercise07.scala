...
/**
  * Hard: Prove that all monads are applicative functors by showing that if the monad laws hold, the Monad implementations
  * of map2 and map satisfy the applicative laws.
  */
object Exercise07 {

  /*
    We'll just work through left and right identity, but the basic idea for all these proofs is to substitute the
    definition of all functions, then use the monad laws to make simplifications to the applicative identities.
